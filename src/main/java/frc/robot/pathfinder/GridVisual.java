...
public class GridVisual {
     ...
     */
    public GridVisual(Pathfinder pathfinder) {
     ...
     * 
     * @param outputLocation the complete file location to save at including FileName.PNG
     */
     ...
     */
    private GridVisual addObstacles() {
        for (int x = 0; x < _image.getWidth(); x++) {
            for (int y = 0; y < _image.getHeight(); y++) {
                ...
                else _image.setRGB(x, y, getIntFromColor(0, 0, 0));
            }
        }
        return this;
    }
     ...
     * @return this instance to allow chaining methods
     */
    public GridVisual addWaypoints(PathfinderResult result) {
     ...
     * @return this instance to allow chaining methods
     */
    public GridVisual addTrajectory(PathPlannerTrajectory trajectory) {
