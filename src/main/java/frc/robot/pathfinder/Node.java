...
public class Node {
     ...
     * @param distanceToNearestObstacle the distance from this node to the nearest obstacle
     * @param distanceCutoff when this node is within this distance of a wall, it will be negatively weighted in pathfinding
            ...
            double robotWidth)
    {
        ...
        if (distanceToNearestObstacle < cutoff) // if the node is near a wall, scale distanceWeight from 0-1 based on how close it is
