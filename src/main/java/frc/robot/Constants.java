...
public final class Constants {
        ...
        public final static class DrivetrainConfig {
                ...
                private static final SimpleMotorFeedforward DRIVE_FEED_FORWARD = new SimpleMotorFeedforward(0.35493,
                                2.3014,
                                0.12872);

                private static final double MAX_ATTAINABLE_SPEED = (12.0 - DRIVE_FEED_FORWARD.ks)
                                / DRIVE_FEED_FORWARD.kv;

                // From what I have seen, it is common to only use a P value in pathfollowing
                private static final PathConstraints PATH_CONSTRAINTS = new PathConstraints(2, 2);
